...
def check(price_list, volume_list):
	...
	elif expensive_card_1 > expensive_card_2 * 1.5 or expensive_card_1 > expensive_card_3 * 2 and volume_1 < 2:
		expensive = 1


	#	Alerta si los cromos tienen flujo de ventas
	if sales_flow < 10:
		sales = Fore.RED + '	ALERTA: Los cromos se venden muy poco (menos de 10 ventas en las ultimas 24 hs)' + Fore.WHITE
